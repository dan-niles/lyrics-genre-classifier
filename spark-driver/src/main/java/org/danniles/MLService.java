...
public class MLService {
    ...
    public MLService(SparkSession sparkSession) {
    ...
    public <T extends MLWritable> void saveModel(T model, String modelOutputDirectory) {
        try {
            ...
            throw new RuntimeException(String.format("Exception occurred while saving the model to disk. Details: %s", e.getMessage()));
        }
    }
